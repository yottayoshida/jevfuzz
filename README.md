...
The npm package has not been published. Build from this repository.
...
The approved v0.1 deployment exception is a minimal **Cloudflare Jev adapter**:
...
and [the supplied PRD](docs/PRD.md). Unsupported versions/fields and invalid
...
See [mutation safety](docs/mutation-safety.md).
...
tool. [Verification evidence](docs/verification.md) records live/offline scope
